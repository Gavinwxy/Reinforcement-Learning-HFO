...
if __name__ == '__main__':
	...
	for episode in range(numEpisodes):	
		...
		while status==0:
			learningRate, epsilon, ep_int, k = agent.computeHyperparameters(numTakenActions, episode)
	...
	print(goal_collect)
	with open('SARSA-Log.txt', 'a+') as f:
		f.write('Learning Rate: {}	Epsilon: {}	Decay rate: {}	result: {} \n'.format(agent.learningRate, ep_int, k, str(goal_collect)))
